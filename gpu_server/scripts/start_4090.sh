...
export COSYVOICE_PROMPT_WAV="${COSYVOICE_PROMPT_WAV:-}"
export COSYVOICE_PROMPT_TEXT="${COSYVOICE_PROMPT_TEXT:-}"
export COSYVOICE_INSTRUCT_TEXT="${COSYVOICE_INSTRUCT_TEXT:-}"
